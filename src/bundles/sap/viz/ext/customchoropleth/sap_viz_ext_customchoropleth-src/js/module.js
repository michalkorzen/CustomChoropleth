...
/*<<dependency*/
define("sap_viz_ext_customchoropleth-src/js/module", ["sap_viz_ext_customchoropleth-src/js/render", "sap_viz_ext_customchoropleth-src/js/dataMapping"], function(render, processData) {
    ...
    var moduleFunc = {
        ...
        dispatch: function(){
            if(!this._dispatch) {
                this._dispatch = d3.dispatch("initialized", "startToInit", "showDataFilter", "hideDataFilter");
            }
        ...
        setSelectedObjects: function(data) {
            this._selectedObjs = JSON.parse(JSON.stringify(data));
        },
        getSelectedObjects: function(data, option) {
